...
kapp deploy -a kc -f https://github.com/carvel-dev/kapp-controller/releases/download/v0.60.6/release.yml -f- --yes << EOF
apiVersion: v1
kind: Secret
metadata:
...
kapp deploy -a sg -f https://github.com/carvel-dev/secretgen-controller/releases/download/v0.21.2/release.yml --yes
